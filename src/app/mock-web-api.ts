...
const FLOW_MANIFESTS = [
    { id: '1000', data: require('./form1.json') },
    { id: '2000', data: require('./form2.json') },
    { id: '3000', data: require('./form3.json') },
];

const LAYOUTS = [
    { id: '1000', data: require('./layout1.json') },
    { id: '2000', data: require('./layout2.json') },
    { id: '3000', data: require('./layout3.json') },
];
...
const EXECUTION_RESULTS = {
    '1000': require('./result1.json'),
    '2000': require('./result2.json'),
    '3000': require('./result3.json')
};
